                    ...
                    <div className='card border-0 shadow'style={{width:'600px',height:'870px'}}>
                        <div className='card-body'>
                            <form className='container py-3  mb-3' onSubmit={handleSubmit}>
                                ...
                                <div className="row mb-3">
                                    <label htmlFor="inputEmail3" className="col-sm-2 col-form-label" name='amount'>Address</label>
                                    <div className="col-sm-10">
                                ...
                                <div className="row mb-3">
                                    <label htmlFor="inputPassword3" className="col-sm-2 col-form-label" name='description'>Company Name</label>
                                    <div className="col-sm-10">
                                ...
                                <div className="row mb-3">
                                    <label htmlFor="inputPassword3" className="col-sm-2 col-form-label" name='paymentDate'>Contact Person</label>
                                    <div className="col-sm-10">
                                ...
                                <div className="row mb-3">
                                    <label htmlFor="inputPassword3" className="col-sm-2 col-form-label" name="paymentMode">Email</label>
                                    <div className="col-sm-10">
                                ...
                                <div className="row mb-3">
                                    <label htmlFor="inputPassword3" className="col-sm-2 col-form-label" name="createdBy">GSTIN</label>
                                    <div className="col-sm-10">
                                        <input value={data.gstin || ''}
                                ...
                                <div className="row mb-3">
                                    <label htmlFor="inputPassword3" className="col-sm-2 col-form-label" name="category">Phone</label>
                                    <div className="col-sm-10">
                                ...
                                <div className="d-grid gap-2 col-6 mx-auto">
                                    <button className="btn btn-outline-success" type="submit">Update Client</button>
                                </div>
